...
def train():
    ...
    coreml = ct.convert(
        ...
        outputs=[
            # Explicitly name the output "logits" so Swift can find it
    ...
    coreml.author      = "Chase AI Team"
    coreml.description = "Financial intent classifier — 8 classes"
    coreml.version     = "1.0"

    output_path = "../../iOS/Sources/CoreML/Models/ChaseIntentClassifier.mlpackage"
    os.makedirs(os.path.dirname(output_path), exist_ok=True)
    coreml.save(output_path)
